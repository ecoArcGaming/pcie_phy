...
HD_PWD='C:/Users/erik3/Downloads/pcie_phy/fpga/pcie_phy.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log phy_link_serial.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source phy_link_serial.tcl
